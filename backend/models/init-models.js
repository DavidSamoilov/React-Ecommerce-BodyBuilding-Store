...
function initModels(sequelize) {
  ...
  categories.belongsToMany(products, {
    as: "product_id_products_product_categories",
  ...
  product_categories.belongsTo(categories, {
    as: "category",
    foreignKey: "category_id",
  });
  categories.hasMany(product_categories, {
  ...
  products_inventory.belongsTo(products, {
    as: "product",
    foreignKey: "product_id",
  });
  products.hasMany(products_inventory, {
    as: "products_inventories",
    foreignKey: "product_id",
  });
  orders.belongsTo(user_address, {
    as: "user_address",
